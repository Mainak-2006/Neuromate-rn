...
export const useSocialAuth = () => {
  ...
  const handleSocialAuth = async (strategy: "oauth_google" | "oauth_facebook" | "oauth_apple") => {
    setIsLoading(true);
    try {
      const startOAuthFlow = strategy === "oauth_google" ? startGoogleOAuth : strategy === "oauth_facebook" ? startFacebookOAuth : startAppleOAuth;
      ...
      const provider = strategy === "oauth_google" ? "Google" : strategy === "oauth_facebook" ? "Facebook" : "Apple";
